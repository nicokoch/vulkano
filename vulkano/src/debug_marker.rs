...
//impl_debug_object!(PhysicalDevice, vk::DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT);
//impl_debug_object!(Queue, vk::DEBUG_REPORT_OBJECT_TYPE_QUEUE_EXT);
impl_debug_object!(Semaphore, vk::DEBUG_REPORT_OBJECT_TYPE_SEMAPHORE_EXT);
//impl_debug_object!(UnsafeCommandBuffer, vk::DEBUG_REPORT_OBJECT_TYPE_COMMAND_BUFFER_EXT);
...
//impl_debug_object!(BufferView<F, B>, vk::DEBUG_REPORT_OBJECT_TYPE_BUFFER_VIEW_EXT);
...
//impl_debug_object!(ComputePipeline, vk::DEBUG_REPORT_OBJECT_TYPE_PIPELINE_EXT);
//impl_debug_object!(GraphicsPipeline, vk::DEBUG_REPORT_OBJECT_TYPE_PIPELINE_EXT);
impl_debug_object!(UnsafeDescriptorSetLayout, vk::DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT_EXT);
//impl_debug_object!(Framebuffer, vk::DEBUG_REPORT_OBJECT_TYPE_FRAMEBUFFER_EXT);
